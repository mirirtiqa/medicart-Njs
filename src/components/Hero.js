...
export default function Hero(){
    return(
       <section className="w-full h-[75vh] bg-cover
         flex"
        ...
        {/* leftscetion */}
         ...
         <div className="relative top-20 left-4 flex flex-col gap-10 md:w-[60%] md:h-3/4">
            <div className="flex flex-col gap-3 text-white">
                <h1 className="text-5xl font-extrabold">Find top quality <span className="text-green">medical products</span></h1>
                <h1 className="text-5xl font-extrabold">for your needs</h1>
